...
type User struct {
	...
	Money     int64     `boil:"money" json:"money" toml:"money" yaml:"money"`
	LastDaily time.Time `boil:"last_daily" json:"last_daily" toml:"last_daily" yaml:"last_daily"`
...
var UserWhere = struct {
	...
	Money     whereHelperint64
	LastDaily whereHelpertime_Time
	...
	Money:     whereHelperint64{field: "\"users\".\"money\""},
	LastDaily: whereHelpertime_Time{field: "\"users\".\"last_daily\""},
...
type userR struct {
	OwnerCat *Cat `boil:"OwnerCat" json:"OwnerCat" toml:"OwnerCat" yaml:"OwnerCat"`
}
...
var (
	userAllColumns            = []string{"id", "discord_id", "money", "last_daily", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"discord_id", "created_at", "updated_at", "deleted_at"}
	userColumnsWithDefault    = []string{"id", "money", "last_daily"}
...
// OwnerCat pointed to by the foreign key.
func (o *User) OwnerCat(mods ...qm.QueryMod) catQuery {
...
// LoadOwnerCat allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-1 relationship.
func (userL) LoadOwnerCat(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`cats`),
		qm.WhereIn(`cats.owner_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load Cat")
	}

	var resultSlice []*Cat
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice Cat")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for cats")
	}
...
// SetOwnerCat of the user to the related item.
// Sets o.R.OwnerCat to related.
// Adds o to related.R.Owner.
func (o *User) SetOwnerCat(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Cat) error {
	var err error
